    ...
    >
      {(dataset) => {
        ...
        const rows = viewModel.rows.filter((row) =>
          `${row.title} ${row.engagementName} ${row.siteName}`
            .toLowerCase()
        ...
        return (
          <>
            <PageHeader
              ...
              actions={
                <Button onClick={() => setShowForm((value) => !value)}>
                  {showForm ? 'Close form' : 'Plan site walk'}
                </Button>
              }
            />
            {showForm ? (
              <Card title="Plan a site walk">
                <SiteWalkForm onSaved={() => setShowForm(false)} />
              </Card>
            ) : null}
            ...
            <Card
              title="Walk register"
              description="Open a walk to capture observations, evidence, friction estimates, and post-tour decisions."
            >
              <input
                className="search-input"
                aria-label="Search site walks"
              ...
              <DataTable
                ...
                columns={[
                  ...
                  },
                  {
                    header: 'Capture',
                    render: (row) =>
                      `${row.scopeCount} scope · ${row.followUpCount} follow-up`,
                  },
      ...
      {(loadedDataset) => {
        ...
        return (
          <>
            ...
            {capture === 'friction' ? (
              <Card title="Record friction or loss">
                <FrictionForm
                  siteWalkId={walk.id}
                  onSaved={() => setCapture(null)}
                />
            ...
            <Card
              title={`Friction and loss-aversion (${friction.length})`}
            ...
            >
              <DataTable
                ...
                columns={[
                  ...
                  { header: 'Friction', render: (row) => row.frictionPoint },
                  {
